...
docker-build: docker-build-nse-ssvpp docker-build-vpp-base docker-build-strongswan-base docker-build-ssvpp

# Individual targets are found in .nsm.mk
docker-push: docker-login docker-push-nse-ssvpp docker-push-vpp-base docker-push-strongswan-base docker-push-ssvpp
